...
# bats file_tags= ipv4, ipv6


# bats test_tags= snmp-v1, snmp-v2c, snmp-v3, lan, wan, udp, tcp
@test "Can scan range of default LAN and WAN IPv4 and IPv6 UDP targets for snmp v1, v2c, and v3 and TCP targets" {
    run \
      masscan \
        -pU:161 \
        -p135,137 \
